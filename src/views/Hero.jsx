                ...
                <div className='flex flex-col gap-y-20 text-center overflow-hidden font-inter items-center relative w-full h-screen'>
                    ...
                    <div className="flex flex-col gap-y-10 z-20 h-full justify-center">
                        <div className='flex flex-col gap-y-5 items-center'>
                            <motion.p className='tracking-[0.5rem] font-medium text-sm text-yllw' initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y:0 }} transition={{ duration: 1 }}>THE ANCIENT GOLDEN BULL</motion.p>
                        ...
                        <motion.p className='text-white max-w-[30rem] font-extralight' initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y:0 }} transition={{ duration: 1, delay: 0.9 }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus suscipit cursus dolor vitae euismod. </motion.p>
                        <motion.div className="flex gap-[1rem] items-center justify-center font-uncial" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y:0 }} transition={{ duration: 1, delay: 1.2 }}>
                            <button className="bg-yllw hover:bg-yllw/70 text-white py-[1rem] px-[2rem] rounded-[7px] border-solid border-yllw border-[2px]">But Token</button>
                            <button className="bg-transparent hover:bg-yllw/20 text-white py-[1rem] px-[2rem] rounded-[7px] border-solid border-yllw border-[2px]">Charts</button>
                        </motion.div>
                    </div>
